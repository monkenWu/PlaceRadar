...
$("#mwt_slider_btn_new").click(function(){
 	closeTab();
 	window.open(url+'home/single?addr='+thisAddr+'&country='+thisCountry,'PlaceRadar','width=800,height=1400, toolbar=yes')
});
